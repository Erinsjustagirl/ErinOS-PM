...
`var myVar = "contents can either be strings or numbers!";` adds a variable. As you saw, it can either be a string, **or** a number. How fun! These can be printed to the console.
